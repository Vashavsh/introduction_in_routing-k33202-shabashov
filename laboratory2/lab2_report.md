...
![](https://github.com/Vashavsh/introduction_in_routing-k33202-shabashov/blob/main/laboratory2/Схема.png "Схема сети")
...
![](https://github.com/Vashavsh/introduction_in_routing-k33202-shabashov/blob/main/laboratory2/Picture1.png "Проверка доступности сетей PC1 и PC2 с PC3.")
![](https://github.com/Vashavsh/introduction_in_routing-k33202-shabashov/blob/main/laboratory2/Picture2.png "Проверка доступности с PC2.")

**Вывод:** В данной лабораторной работе я ознакомилась с принципами планирования IP адресов, с настройкой статической маршрутизации, а также с сетевыми функциями устройств.
